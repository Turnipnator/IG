...
MARKETS = [
    ...
    # ),
    # Bitcoin removed 2026-09-09 (shadow observer 09-01 → 09-09): the FCA bars crypto
    # derivatives for UK retail accounts, and its 12-year backtest "edge" is 175x secular
    # drift with a negative first half — not a strategy the bot can validate. Do not re-add
    # without professional-client status on the live account.
]
